...
public class LibraryPage extends PageBase {
	...
	public void userAddLibrary() {
		addLibraryButton=drvier.findElement(By.id("add_files_tv"));
		clickButton(addLibraryButton);
		new WebDriverWait(drvier, 10).until(ExpectedConditions.visibilityOfElementLocated(By.id("sp_school_edu_sys"))).click();
		drvier.findElement(By.xpath("//android.widget.TextView[@text='IGCSE']")).click();
		drvier.findElement(By.id("et_title")).setValue("Test");
		...
		drvier.findElement(By.id("et_external_link")).sendKeys("https://www.google.com");
